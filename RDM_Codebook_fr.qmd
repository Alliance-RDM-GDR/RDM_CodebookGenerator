...
🌍 <a href="https://alliance-rdm-gdr.github.io/RDM_CodebookGenerator/RDM_Codebook_en.html" target="_blank">🇺🇸 English Version</a>
</div>
:::
...
::: {.callout-tip}
Selon la discipline, d'autres attributs peuvent être décrits pour rendre l’ensemble de données plus compréhensible. Cliquez [ici](https://osf.io/925sh) pour voir un exemple.
:::

## Comment créer un codebook

Créer des livres de code est une bonne pratique scientifique qui devrait être mise en place dès le début du processus de recherche. Il est recommandé d’utiliser un format simple et clair. L’application web de l’Alliance, accessible [ici](https://rdm-codebook-generator.vercel.app/), permet de générer un fichier .CSV à partir d’un tableau de données donné.
