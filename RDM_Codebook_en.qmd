...
::: {.callout-tip}
Depending on the discpline, more attributes could be describe to make the dataset understandable. Click [here](https://osf.io/925sh) to see an example.
:::

## How to create a codebook 

Creating codebooks is a good scientific practice that should be implemented during the research process. Keep the format as simple as possible. The Alliance web application [here](https://rdm-codebook-generator.vercel.app/) allows the user to download a .CSV codebook derived from a given data table.
